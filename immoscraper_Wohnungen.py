...
def urlquery(url):
    ...
    try:
        sleeptime = float(random.randint(1,20))/5
...
#searchlists.append(['Sachsen-Anhalt', 'Magdeburg', 'Wohnung','Kauf'])
#searchlists.append(['Sachsen-Anhalt', 'Magdeburg', 'Haus','Kauf'])
